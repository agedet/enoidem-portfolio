...
export const metadata: Metadata = {
  ...
  description: "The personal website of Professor Enoidem Usoro, a professor in the field of Business Education.",
  openGraph: {
    title: "Professor Enoidem Usoro",
    description: "The personal website of Professor Enoidem Usoro, a professor in the field of Business Education.",
    url: "https://enoidemusoro.com",
    siteName: "Professor Enoidem Usoro",
    images: [
      {
        url: "/professor-enoidem.jpg",
        width: 1200,
        height: 630,
