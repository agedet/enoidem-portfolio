        ...
        <div>
            ...
            >
                ...
                <TabsContent value='journal-articles' className='w-full'>
                    ...
                    <div className="mt-12">
                        <a className="inline-flex items-baseline font-medium leading-tight text-slate-200 hover:text-primary focus-visible:text-primary font-semibold text-slate-200 group/link text-base" aria-label="View Full Project Archive" href="/archive">
                            <span>
